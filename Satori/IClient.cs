...
namespace Satori
{
    ...
    public interface IClient
    {
        ...
        /// </summary>
        /// <param name="session">The session of the user.</param>
        /// <param name="id">The identifier of the identity.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> that can be used to cancel the request while mid-flight.</param>
        /// <returns>A task object.</returns>
        public Task DeleteIdentityAsync(ISession session, string id, CancellationToken? cancellationToken = default);
    }
}
