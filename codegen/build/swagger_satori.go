...
//build:ignore
//go:generate protoc -I $SATORI_DIR -I $SATORI_DIR/build/grpc-gateway-v2.3.0/third_party/googleapis -I $SATORI_DIR/vendor/github.com/grpc-ecosystem/grpc-gateway/v2 --openapiv2_out=. --openapiv2_opt=logtostderr=true $SATORI_PROTO_FILE
