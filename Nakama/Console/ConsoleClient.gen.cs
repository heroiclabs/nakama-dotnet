...
namespace NakamaConsole
{
    ...
    /// </summary>
    public interface IConsoleAddGroupUsersBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleAddGroupUsersBody : IConsoleAddGroupUsersBody
    {
    ...
    /// </summary>
    public interface IConsoleCallApiEndpointBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleCallApiEndpointBody : IConsoleCallApiEndpointBody
    {
    ...
    /// API Explorer request definition for CallApiEndpoint
    /// </summary>
    public interface IConsoleCallRpcEndpointBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleCallRpcEndpointBody : IConsoleCallRpcEndpointBody
    {
    ...
    /// </summary>
    public interface IConsoleRequireUserMfaBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleRequireUserMfaBody : IConsoleRequireUserMfaBody
    {
    ...
    /// </summary>
    public interface IConsoleUnlinkDeviceBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleUnlinkDeviceBody : IConsoleUnlinkDeviceBody
    {
    ...
    /// </summary>
    public interface IConsoleUpdateAccountBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleUpdateAccountBody : IConsoleUpdateAccountBody
    {
    ...
    /// </summary>
    public interface IConsoleUpdateGroupBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleUpdateGroupBody : IConsoleUpdateGroupBody
    {
    ...
    /// </summary>
    public interface IConsoleUpdateSettingBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleUpdateSettingBody : IConsoleUpdateSettingBody
    {
    ...
    /// </summary>
    public interface IConsoleConsoleWriteStorageObjectBody
    {
    ...
    /// <inheritdoc />
    internal class ConsoleConsoleWriteStorageObjectBody : IConsoleConsoleWriteStorageObjectBody
    {
 ...
 - USER_ROLE_READONLY: Read-only role for those only need to view data
    ...
    /// <summary>
    /// The low level client for the NakamaConsole API.
    /// </summary>
    internal class ApiClient
    {
        ...
        public async Task<IConsoleCallApiEndpointResponse> ConsoleCallRpcEndpointAsync(
            string bearerToken,
            string method,
            ConsoleCallRpcEndpointBody body,
            CancellationToken? cancellationToken)
        {
            if (method == null)
            {
        ...
        public async Task<IConsoleCallApiEndpointResponse> ConsoleCallApiEndpointAsync(
            string bearerToken,
            string method,
            ConsoleCallApiEndpointBody body,
            CancellationToken? cancellationToken)
        {
            if (method == null)
            {
        ...
        public async Task<IApiStorageObjectAck> ConsoleWriteStorageObjectAsync(
            ...
            string key,
            string user_id,
            ConsoleConsoleWriteStorageObjectBody body,
            CancellationToken? cancellationToken)
        {
            if (collection == null)
            {
        ...
        public async Task ConsoleRequireUserMfaAsync(
            string bearerToken,
            string username,
            ConsoleRequireUserMfaBody body,
            CancellationToken? cancellationToken)
        {
            if (username == null)
            {
