...
namespace NakamaSync
{
    ...
    public class SyncMatch
    {
        ...
        internal SyncMatch(ISession session, SyncSocket socket, SyncVarRegistry registry, PresenceTracker presenceTracker, RolePresenceTracker rolePresenceTracker)
        {
            ...
            CreateIngresses();
            CreateEgresses();
            CreateHandshaker(_sharedIngress, _userIngress);
        }
        ...
        private void CreateHandshaker(SharedRoleIngress sharedIngress, UserRoleIngress userIngress)
        {
            ...
            new Handshaker(guestHandshaker, hostHandshaker, _rolePresenceTracker);
        }
    }
}
